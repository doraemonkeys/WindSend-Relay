...

{
    ...
    if [[ "$version_range" == *...* ]]; then
        echo "**Full Changelog**: https://github.com/doraemonkeys/WindSend-Relay/compare/$version_range"
    else
        echo "**Full Changelog**: https://github.com/doraemonkeys/WindSend-Relay/commits/$version_range"
    fi
} >release.md
